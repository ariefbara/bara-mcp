...
class AttendeeControllerTest extends AsMeetingInitiatorTestCase
{
    ...
    protected function executeShowAll()
    {
        ...
        $this->get($this->showAttendeeUri, $this->user->token);
    }
    ...
    protected function executeShow()
    {
        ...
        $this->get($this->showAttendeeUri . "/{$this->coordinatorInviteeOne->invitee->id}", $this->user->token);
    }
    ...
    protected function executeInviteManager()
    {
        ...
        $this->put($uri, ['managerId' => $this->managerOne->id], $this->programParticipation->user->token);
    }
    ...
    protected function executeInviteCoordinator()
    {
        ...
        $this->put($uri, ['coordinatorId' => $this->coordinatorOne->id], $this->programParticipation->user->token);
    }
    ...
    protected function executeInviteConslutant()
    {
        ...
        $this->put($uri, ['consultantId' => $this->consultantOne->id], $this->programParticipation->user->token);
    }
    ...
    protected function executeInviteParticipant()
    {
        ...
        $this->put($uri, ['participantId' => $this->userParticipantOne->participant->id], $this->programParticipation->user->token);
    }
