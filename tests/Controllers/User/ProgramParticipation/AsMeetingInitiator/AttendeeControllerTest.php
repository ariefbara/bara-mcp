...
class AttendeeControllerTest extends AsMeetingInitiatorTestCase
{
    ...
    public function test_inviteManager_200()
    {
        ...
        $this->put($uri, $this->inviteManagerInput, $this->programParticipation->user->token)
                ->seeStatusCode(200);
...
$this->disableExceptionHandling();
        ...
        $this->put($uri, $this->inviteCoordinatorInput, $this->programParticipation->user->token)
                ->seeStatusCode(200);
    ...
    public function test_inviteConsultant_200()
    {
        ...
        $this->put($uri, $this->inviteConsultantInput, $this->programParticipation->user->token)
                ->seeStatusCode(200);
    ...
    public function test_inviteParticipant_200()
    {
        ...
        $this->put($uri, $this->inviteParticipantInput, $this->programParticipation->user->token)
                ->seeStatusCode(200);
