...
class WorksheetController_containAttachmentFieldTest extends WorksheetTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $userFileInfoOneOne = new RecordOfUserFileInfo($this->programParticipation->user, $this->fileInfoOneOne);
        $userFileInfoOneTwo = new RecordOfUserFileInfo($this->programParticipation->user, $this->fileInfoOneTwo);
        $userFileInfoOneThree = new RecordOfUserFileInfo($this->programParticipation->user, $this->fileInfoOneThree);
        $userFileInfoTwoOne = new RecordOfUserFileInfo($this->programParticipation->user, $this->fileInfoTwoOne);
        $userFileInfoThreeOne = new RecordOfUserFileInfo($this->programParticipation->user, $this->fileInfoThreeOne);
        $this->connection->table('UserFileInfo')->insert($userFileInfoOneOne->toArrayForDbEntry());
        $this->connection->table('UserFileInfo')->insert($userFileInfoOneTwo->toArrayForDbEntry());
        $this->connection->table('UserFileInfo')->insert($userFileInfoOneThree->toArrayForDbEntry());
        $this->connection->table('UserFileInfo')->insert($userFileInfoTwoOne->toArrayForDbEntry());
        $this->connection->table('UserFileInfo')->insert($userFileInfoThreeOne->toArrayForDbEntry());
