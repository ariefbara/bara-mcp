...
class ProfileControllerTest extends ProgramParticipationTestCase
{
    ...
    public function test_submit_200()
    {
        ...
        $this->put($uri, $this->submitInput, $this->programParticipation->user->token)
    ...
    public function test_remove_200()
    {
        ...
        $this->delete($uri, [], $this->programParticipation->user->token)
                ->seeStatusCode(200);
    ...
    public function test_showAll_scenario_expectedResult()
    {
        ...
        $this->get($this->profileUri, $this->programParticipation->user->token)
                ->seeJsonContains($response)
                ->seeStatusCode(200);
    }
}
