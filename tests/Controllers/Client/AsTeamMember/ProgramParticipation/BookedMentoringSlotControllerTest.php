...
class BookedMentoringSlotControllerTest extends ProgramParticipationTestCase
{
    ...
    protected function book()
    {
        ...
        $uri = $this->programParticipationUri . "/{$this->programParticipation->id}/mentoring-slots/{$this->mentoringSlotOne->id}/booked-mentoring-slots";
        $this->post($uri, [], $this->teamMember->client->token);
    }
    ...
    protected function cancel()
    {
        ...
        $uri = $this->programParticipationUri . "/{$this->programParticipation->id}/booked-mentoring-slots/{$this->bookedMentoringSlotOne->mentoring->id}";
    ...
    protected function submitReport()
    {
        ...
        $uri = $this->programParticipationUri . "/{$this->programParticipation->id}/booked-mentoring-slots/{$this->bookedMentoringSlotOne->mentoring->id}/submit-report";
