...
class InviteeControllerTest extends ActivityTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $invitation = new RecordOfInvitee($activity, $this->activityParticipantThree_Participant, 0);
        $invitationOne = new RecordOfInvitee($activity, $this->activityParticipantThree_Participant, 1);
        $invitationTwo = new RecordOfInvitee($activity, $this->activityParticipantThree_Participant, 2);
