...
class MentoringRequestControllerTest extends ExtendedTeamParticipantTestCase
{
    protected $mentorOne;
    ...
    protected function setUp(): void
    {
        ...
        $this->mentoringRequestOne = new RecordOfMentoringRequest($participant, $this->mentorOne, $this->consultationSetupOne, '1');
        $this->mentoringRequestTwo_offered = new RecordOfMentoringRequest($participant, $this->mentorOne, $this->consultationSetupOne, '2');
    ...
    protected function submitRequest()
    {
        ...
        $uri = $this->teamParticipantUri. "/mentoring-requests";
        $this->post($uri, $this->submitRequestData, $this->teamMember->client->token);
    }
    ...
    public function test_submitRequest_inConflictWithExistingBookedMentoring_403()
    {
        ...
        $bookedMentoring = new RecordOfBookedMentoringSlot($mentoringSlot, $mentoring, $this->teamParticipant->participant);
    ...
    public function test_submitRequest_inactiveMember_403()
    {
...
echo $uri;
    ...
    protected function cancel()
    {
        ...
        $uri = $this->teamParticipantUri . "/mentoring-requests/{$this->mentoringRequestOne->id}";
    ...
    protected function accept()
    {
        ...
        $uri = $this->teamParticipantUri . "/mentoring-requests/{$this->mentoringRequestTwo_offered->id}/accept";
