...
class ActiveProgramParticipationSummaryControllerTest extends AsTeamMemberTestCase
{
    ...
    {
        parent::setUp();
        $this->activeProgramParticipationSummaryUri = $this->asTeamMemberUri . '/active-program-participation-summaries';
        ...
        $creator = new RecordOfClient($firm, '2');
        $this->connection->table('Client')->insert($creator->toArrayForDbEntry());
        
        $teamTwo = new RecordOfTeam($firm, $creator, '2');
        ...
        $this->programParticipationOne = new RecordOfTeamProgramParticipation($this->teamMember->team, $participantOne);
        $this->programParticipationTwo = new RecordOfTeamProgramParticipation($this->teamMember->team, $participantTwo);
        $programParticipationThree = new RecordOfTeamProgramParticipation($this->teamMember->team, $participantThree);
        $programParticipation_21 = new RecordOfTeamProgramParticipation($teamTwo, $participant_21);
        $this->connection->table('TeamParticipant')->insert($this->programParticipationOne->toArrayForDbEntry());
        $this->connection->table('TeamParticipant')->insert($this->programParticipationTwo->toArrayForDbEntry());
        $this->connection->table('TeamParticipant')->insert($programParticipationThree->toArrayForDbEntry());
        $this->connection->table('TeamParticipant')->insert($programParticipation_21->toArrayForDbEntry());
