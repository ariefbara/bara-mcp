...
class ProgramRegistrationControllerTest extends TeamMembershipTestCase
{
    ...
    public function test_register_alreadyRegistedInProgram_403()
    {
        ...
        $teamProgramRegistration = new RecordOfTeamProgramRegistration($this->teamMembership->team, $registrant);
        $this->connection->table('Registrant')->insert($registrant->toArrayForDbEntry());
    ...
    public function test_register_alreadyParticipateInProgram_403()
    {
        ...
        $teamProgramParticipation = new RecordOfTeamProgramParticipation($this->teamMembership->team, $participant);
