...
class ProfileControllerTest extends ProgramRegistrationTestCase
{
    ...
    public function test_submit_200()
    {
        ...
        $this->put($uri, $this->submitInput, $this->programRegistration->client->token)
    ...
    public function test_remove_200()
    {
        ...
        $this->delete($uri, [], $this->programRegistration->client->token)
                ->seeStatusCode(200);
    ...
    public function test_show_200()
    {
        ...
        $uri = $this->profileUri . "/{$this->profileOne->programsProfileForm->id}";
        $this->get($uri, $this->programRegistration->client->token)
                ->seeJsonContains($response)
                ->seeStatusCode(200);
    }
    ...
    public function test_showAll_scenario_expectedResult()
    {
        ...
        $this->get($this->profileUri, $this->programRegistration->client->token)
                ->seeJsonContains($response)
                ->seeStatusCode(200);
    }
}
