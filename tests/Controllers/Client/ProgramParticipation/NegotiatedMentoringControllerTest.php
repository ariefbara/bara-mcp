...
class NegotiatedMentoringControllerTest extends ExtendedClientParticipantTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $mentoringRequestOne = new RecordOfMentoringRequest($this->clientParticipant->participant, $mentorOne, $consultationSetupOne, '1');
    ...
    protected function submit()
    {
        ...
        $uri = $this->clientParticipantUri . "/negotiated-mentorings/{$this->negotiatedMentoringOne->id}/submit-report";
    ...
    {
        $participant = new RecordOfParticipant($this->clientParticipant->participant->program, 'zzz');
    ...
    protected function show()
    {
        ...
        $uri = $this->clientParticipantUri . "/negotiated-mentorings/{$this->negotiatedMentoringOne->id}";
