...
class DeclaredMentoringControllerTest extends ExtendedClientParticipantTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->participantReportOne_dm1 = new RecordOfParticipantReport($mentoringOne_dm1, $formRecordOne_pr_dm1, '1-dm1');
        $this->stringFieldRecordOne_pr_dm1 = new RecordOfStringFieldRecord($formRecordOne_pr_dm1, $this->stringFieldOne_ff1, '1-pr-dm1');
    ...
    protected function declare()
    {
        ...
        $uri = $this->clientParticipantUri . "/declared-mentorings";
echo $uri;
        $this->post($uri, $this->declareRequest, $this->clientParticipant->client->token);
    }
    ...
    protected function update()
    {
        ...
        $uri = $this->clientParticipantUri . "/declared-mentorings/{$this->declaredMentoringOne->id}/update";
    ...
    protected function cancel()
    {
        ...
        $uri = $this->clientParticipantUri . "/declared-mentorings/{$this->declaredMentoringOne->id}/cancel";
    ...
    protected function approve()
    {
        ...
        $uri = $this->clientParticipantUri . "/declared-mentorings/{$this->declaredMentoringOne->id}/approve";
        $this->patch($uri, [], $this->clientParticipant->client->token);
    }
    ...
    protected function deny()
    {
        ...
        $uri = $this->clientParticipantUri . "/declared-mentorings/{$this->declaredMentoringOne->id}/deny";
        $this->patch($uri, [], $this->clientParticipant->client->token);
    }
    ...
    protected function submitReport()
    {
        ...
        $uri = $this->clientParticipantUri . "/declared-mentorings/{$this->declaredMentoringOne->id}/submit-report";
    ...
    protected function show()
    {
        ...
        $uri = $this->clientParticipantUri . "/declared-mentorings/{$this->declaredMentoringOne->id}";
