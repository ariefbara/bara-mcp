...
class InvitationControllerTest extends CoordinatorTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->invitation = new RecordOfActivityInvitation($this->coordinator, $invitation);
        $this->invitationOne = new RecordOfActivityInvitation($this->coordinator, $invitationOne);
        $this->invitationTwo = new RecordOfActivityInvitation($this->coordinator, $invitationTwo);
        $this->invitationThree = new RecordOfActivityInvitation($this->coordinator, $invitationThree);
        $this->connection->table("CoordinatorInvitee")->insert($this->invitation->toArrayForDbEntry());
        $this->connection->table("CoordinatorInvitee")->insert($this->invitationOne->toArrayForDbEntry());
        $this->connection->table("CoordinatorInvitee")->insert($this->invitationTwo->toArrayForDbEntry());
        $this->connection->table("CoordinatorInvitee")->insert($this->invitationThree->toArrayForDbEntry());
    ...
    public function test_showAll_cancelledStatusFilterApplied_200()
    {
        $uri = $this->invitationUri . "?cancelledStatus=false";
        $response = [
            "total" => 3,
            "list" => [
                [
