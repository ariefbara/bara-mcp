...
class ParticipantProfileControllerTest extends ExtendedCoordinatorTestCase
{
    ...
    protected function show()
    {
        ...
        $uri = $this->coordinatorUri . "/participant-profiles/{$this->participantProfileOne_p1->id}";
...
$this->disableExceptionHandling();
    ...
    protected function showAll()
    {
        ...
        $uri = $this->coordinatorUri . "/participants/{$this->participantOne->id}/profiles";
        $this->get($uri, $this->personnel->token);
    }
