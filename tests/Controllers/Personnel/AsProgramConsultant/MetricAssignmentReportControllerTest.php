...
use Tests\Controllers\Personnel\AsProgramConsultant\ParticipantTestCase;
...
use Tests\Controllers\RecordPreparation\User\RecordOfUserFileInfo;
...
class MetricAssignmentReportControllerTest extends ParticipantTestCase
{
    ...
    public function test_show_200()
    {
        ...
        $uri = $this->asProgramConsultantUri . "/metric-assignment-reports/{$this->metricAssignmentReport->id}";
    ...
    public function test_showAll_200()
    {
        ...
        $uri = $this->asProgramConsultantUri . "/participant/{$this->participant->id}/metric-assignment-reports";
        $this->get($uri, $this->consultant->personnel->token)
