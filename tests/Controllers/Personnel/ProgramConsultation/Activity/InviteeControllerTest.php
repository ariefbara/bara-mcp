...
class InviteeControllerTest extends ActivityTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $invitationOne = new RecordOfInvitee($activity, $this->activityParticipant_consultant, 1);
        $invitationTwo = new RecordOfInvitee($activity, $this->activityParticipant_consultant, 2);
        $invitationThree = new RecordOfInvitee($activity, $this->activityParticipant_consultant, 3);
