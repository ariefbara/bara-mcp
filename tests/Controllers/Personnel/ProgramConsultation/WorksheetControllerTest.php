...
class WorksheetControllerTest extends ExtendedConsultantTestCase
{
    ...
    {
        parent::setUp();
        $this->worksheetUri = $this->consultantUri . "/worksheets";
...
$this->disableExceptionHandling();
    ...
    public function test_viewAll_inactiveConsultant_403()
    {
    ...
    public function test_viewDetail_inactiveConsultant_403()
    {
        $this->consultant->active = false;
