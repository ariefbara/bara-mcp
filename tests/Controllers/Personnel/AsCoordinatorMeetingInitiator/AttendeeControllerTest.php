...
class AttendeeControllerTest extends AsMeetingInitiatorTestCase
{
    ...
    public function test_inviteAllActiveProgramParticipants_200()
    {
        $this->connection->table('ParticipantInvitee')->truncate();
        ...
        $uri = $this->attendeeUri . "/invite-all-active-program-participants";
        $this->put($uri, $this->inviteParticipantInput, $this->personnel->token)
                ->seeStatusCode(200);
        
        $teamParticipantInviteeEntry = ['Participant_id' => $this->teamParticipant->participant->id];
        $this->seeInDatabase('ParticipantInvitee', $teamParticipantInviteeEntry);
        
        $userParticipantInviteeEntry = ['Participant_id' => $this->userParticipant->participant->id];
        $this->seeInDatabase('ParticipantInvitee', $userParticipantInviteeEntry);
        
        $clientParticipantInviteeEntry = ['Participant_id' => $this->clientParticipant->participant->id];
        $this->seeInDatabase('ParticipantInvitee', $clientParticipantInviteeEntry);
        
        $teamParticipantThreeInviteeEntry = ['Participant_id' => $this->teamParticipantThree->participant->id];
        $this->seeInDatabase('ParticipantInvitee', $teamParticipantThreeInviteeEntry);
    }
