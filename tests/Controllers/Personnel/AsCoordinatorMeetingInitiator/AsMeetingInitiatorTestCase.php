...
class AsMeetingInitiatorTestCase extends PersonnelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->coordinator = new RecordOfCoordinator($program, $this->personnel, 'author');
        ...
        $this->meetingAttendace = new RecordOfActivityInvitation($this->coordinator, $attendee, '1');
        $this->connection->table("CoordinatorInvitee")->insert($this->meetingAttendace->toArrayForDbEntry());
        
        $this->asMeetingInitiatorUri = $this->personnelUri . "/as-coordinator-meeting-initiator/{$this->meeting->id}";
    }
