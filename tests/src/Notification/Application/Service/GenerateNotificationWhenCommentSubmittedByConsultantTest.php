...
class GenerateNotificationWhenCommentSubmittedByConsultantTest extends TestBase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new GenerateNotificationWhenCommentSubmittedByConsultant($this->commentRepository);
    }
    ...
    public function test_execute_executeCommentsGenerateNotificationTriggeredByConsultantMethod()
    {
