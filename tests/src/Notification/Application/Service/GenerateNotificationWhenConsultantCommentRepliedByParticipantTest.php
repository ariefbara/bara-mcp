...
class GenerateNotificationWhenConsultantCommentRepliedByParticipantTest extends TestBase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new GenerateNotificationWhenConsultantCommentRepliedByParticipant($this->commentRepository);
    }
    ...
    public function test_execute_executeCommentsgenerateNotificationsForRepliedConsultantCommentMethod()
    {
