...
class CreateClientResetPasswordMailTest extends TestBase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new CreateClientResetPasswordMail($this->clientMailRepository, $this->clientRepository);
    }
