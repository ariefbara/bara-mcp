...
class MentorAssignTest extends TestBase
{
    protected $service;
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new MentorAssign($this->programRepository, $this->personnelRepository);
    }
    ...
    public function test_execute_executeCohortsAssignMentorMethod()
    {
        $this->program->expects($this->once())
            ->method('assignPersonnelAsMentor')
            ->with($this->personnel);
        $this->execute();
    }
