...
class AcceptClientRegistrationTest extends TestBase
{
    protected $service;
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new AcceptClientRegistration($this->programRepository, $this->dispatcher);
    }
    ...
    public function test_execute_executeProgramsAcceptRegistrantMethod()
    {
        $this->program->expects($this->once())
                ->method('acceptClientRegistration')
