...
class CancelInvitationTest extends TestBase
{
    ...
    protected $service;
    protected $firmId = "firmId", $managerId = "managerId", $meetingId = "meetingId", $attendeeId = "attendeeId";
    ...
    {
        $this->service->execute($this->firmId, $this->managerId, $this->meetingId, $this->attendeeId);
    }
