...
class EnableActivityTypeTest extends TestBase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new EnableActivityType($this->activityTypeRepository, $this->managerRepository);
    }
    ...
    public function test_execute_managerEnableActivityType()
    {
        $this->manager->expects($this->once())
                ->method("enableActivityType")
