...
class InviteConsultantToAttendMeetingTest extends TestBase
{
    ...
    protected $service;
    protected $userParticipantId = "userParticipantId", $meetingId = "meetingId", $consultantId = "consultantId";
    ...
    protected function setUp(): void
    {
        ...
        $this->attendeeRepository->expects($this->any())
                ...
                ->with($this->userParticipantId, $this->meetingId)
    ...
    {
        $this->service->execute($this->userParticipantId, $this->meetingId, $this->consultantId);
    }
