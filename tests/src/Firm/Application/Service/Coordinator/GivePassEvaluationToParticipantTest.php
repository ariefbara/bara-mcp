...
class GivePassEvaluationToParticipantTest extends TestBase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new GivePassEvaluationToParticipant(
    ...
    public function test_execute_coordinatorGivePassEvaluationToParticipant()
    {
        ...
        $this->coordinator->expects($this->once())
                ->method("givePassEvaluationToParticipant");
        $this->execute();
    }
