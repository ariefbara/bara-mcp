...
class ConsultationRequestTest extends TestBase
{
    ...
    protected function executeConstruct()
    {
        ...
        return new TestableConsultationRequest($this->programParticipation, $this->id, $this->consultationSetup, $this->consultant, $this->startTime);
    }
    ...
    {
        $this->executeAccept();
        $this->assertEquals(new ConsultationRequestStatusVO("scheduled"),
            $this->consultationRequest->status);
    }
    ...
    public function test_createConsultationSetupSchedule_returnConsultationSetupSchedule()
    {
        ...
        $consultationSession = new ConsultationSession(
            $this->consultationRequest->programParticipation, 
            $id = 'consultationSetupSchedule-id', 
            $this->consultationRequest->consultationSetup, 
            $this->consultationRequest->consultant, 
