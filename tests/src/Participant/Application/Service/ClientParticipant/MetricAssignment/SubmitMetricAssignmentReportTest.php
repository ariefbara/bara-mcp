...
class SubmitMetricAssignmentReportTest extends TestBase
{
    ...
    protected $service;
    protected $clientId = "clientId", $metricAssignmentId = "metricAssignmentId", $observeTime, $metricAssignmentReportData;
    ...
    protected function setUp(): void
    {
        ...
        $this->metricAssignmentRepository->expects($this->any())
                ->method("aMetricAssignmentBelongsToClient")
                ->with($this->clientId, $this->metricAssignmentId)
    ...
    protected function execute()
    {
        return $this->service->execute(
                $this->clientId, $this->metricAssignmentId, $this->observeTime, $this->metricAssignmentReportData);
    }
