...
class TaskExecutableByParticipantTestBase extends TestBase
{
    ...
    protected function setupMentorRelatedAsset(): void
    {
    ...
    protected function setupMentoringRequestRelatedAsset(): void
    {
    ...
    protected function setupConsultationSetupRelatedAsset(): void
    {
    ...
    protected function setupNegotiatedMentoringRelatedAsset(): void
    {
