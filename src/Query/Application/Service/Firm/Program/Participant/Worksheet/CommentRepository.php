...
use Query\ {
    ...
    Application\Service\Firm\Team\ProgramParticipation\Worksheet\CommentRepository as InterfaceForTeam,
...
interface CommentRepository extends InterfaceForClient, InterfaceForUser, InterfaceForTeam
{
