...
class ParticipantTranscriptTable implements IContainSummaryTable
{
    /**
     * 
     * @var EvaluationPlan
    ...
    {
        $mentorEntryColumn = new Entry\EntryColumn(1, $evaluationReport->getMentorName());
    ...
    public function __construct(EvaluationReport $evaluationReport)
    {
        ...
        $initialEntry = $this->generateEntryFromEvaluationReport($evaluationReport);
        $this->summaryTable = new SummaryTable([$initialEntry]);
    }
