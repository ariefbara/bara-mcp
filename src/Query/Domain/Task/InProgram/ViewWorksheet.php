...
class ViewWorksheet implements ProgramTaskExecutableByCoordinator, ProgramTaskExecutableByConsultant
{
    ...
    {
        $payload->result = $this->worksheetRepository->aWorksheetInProgram($programId, $payload->getId());
    }
