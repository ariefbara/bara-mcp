...
class ViewParticipantMissionSummaryList implements ProgramTaskExecutableByCoordinator
{
    ...
    public function execute(string $programId, $payload): void
    {
        $payload->result = $this->participantRepository
                ->participantListWithMissionSummaryInProgram($programId, $payload->getFilter());
    }
