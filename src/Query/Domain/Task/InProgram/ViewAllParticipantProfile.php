...
class ViewAllParticipantProfile implements ProgramTaskExecutableByConsultant, ProgramTaskExecutableByCoordinator
{
     ...
     * @param ViewAllParticipantProfilePayload $payload
     * @return void
     */
    public function execute(string $programId, $payload): void
    {
        $payload->result = $this->participantProfileRepository
                ->allParticipantProfilesBelongsInProgram($programId, $payload->getParticipantProfileFilter());
    }
