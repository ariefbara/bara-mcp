...
class MissionListInCoordinatedProgram implements PersonnelTask
{
    ...
    {
        $payload->result = $this->missionRepository->missionListInAllProgramCoordinatedByPersonnel($personnelId);
    }
