...
class ViewParticipantListInCoordinatedProgram implements PersonnelTask
{
    ...
    public function execute(string $personnelId, $payload): void
    {
        $payload->result = $this->participantRepository
                ->listOfParticipantInAllProgramCoordinatedByPersonnel($personnelId, $payload->getFilter());
    }
