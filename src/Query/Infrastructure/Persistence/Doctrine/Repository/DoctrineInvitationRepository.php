...
use Query\ {
    Application\Service\Firm\Program\Activity\InvitationRepository,
...
class DoctrineInvitationRepository extends EntityRepository implements InvitationRepository
{
