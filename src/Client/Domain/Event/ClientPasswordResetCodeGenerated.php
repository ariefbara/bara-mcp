...
class ClientPasswordResetCodeGenerated implements CanBeMailedEvent
{

    const EVENT_NAME = "ClientPasswordResetCodeGenerated";

    protected $clientName, $clientEmailAddress, $resetPasswordCode;

    function __construct(string $clientName, string $clientEmailAddress, string $resetPasswordCode)
    {
...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8">
        <title>Innov.id Email Notification</title>
    </head>
                                            ...
                                            <tbody><tr>
                                                ...
                                                <tr>
                                                    <td align="center" style="font-family: 'Raleway', sans-serif; font-size:37px; color:#ffffff; line-height:24px; font-weight: bold; letter-spacing: 5px;">
                                                        Account <span style="font-family: 'Raleway', sans-serif; font-size:37px; color:#ffffff; line-height:39px; font-weight: 300; letter-spacing: 5px;">Password Reset Request</span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td align="center" style="font-family: 'Lato', sans-serif; font-size:15px; color:#ffffff; line-height:24px; font-weight: 300;">
                                                        Now you will recive Email everytime you reset the password
                                                    </td>
                                                </tr>
