...
use Client\Application\Listener\ConsultationRequestNotificationEventInterface;

class ConsultationRequestMutatedByConsultantEvent implements ConsultationRequestNotificationEventInterface
{

    const EVENT_NAME = "ConsultationRequestMutatedByConsultantEvent";
