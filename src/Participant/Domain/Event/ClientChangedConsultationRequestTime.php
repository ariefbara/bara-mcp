...
class ClientChangedConsultationRequestTime implements ClientUpdatedConsultationRequestEventInterface
{
    ...
    {
        return EventList::CLIENT_CHANGED_CONSULTATION_REQUEST_TIME;
    }
