...
class ClientParticipantChangedConsultationRequestTime implements ConsultationRequestChangedByClientParticipantEventInterface
{
    ...
    {
        return EventList::CLIENT_PARTICIPANT_CHANGED_CONSULTATION_REQUEST_TIME;
    }
