...
class UserChangedConsultationReqestTime implements UserUpdatedConsultationRequestEventInterface
{
    ...
    {
        return EventList::USER_CHANGED_CONSULTATION_REQUEST_TIME;
    }
