...
use Query\Application\Service\User\AsProgramParticipant\ExecuteParticipantTask;
...
class EvaluationReportController extends UserBaseController
{
    ...
    protected function executeParticipantTaskService(string $participantId, ITaskExecutableByParticipant $task): void
    {
        ...
        $service = new ExecuteParticipantTask($userParticipantRepository);
        $service->execute($this->userId(), $participantId, $task);
    }
