...
class TaskController extends AsTeamMemberBaseController
{
    ...
    public function viewAllTasks($teamId, $teamProgramParticipationId)
    {
    ...
    public function viewConsultantTaskDetail($teamId, $teamProgramParticipationId, $id)
    {
    ...
    public function viewCoordinatorTaskDetail($teamId, $teamProgramParticipationId, $id)
    {
