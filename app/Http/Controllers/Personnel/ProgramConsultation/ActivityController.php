...
class ActivityController extends ConsultantBaseController
{

    public function viewAllValidInvitationsToParticipant($consultantId, $participantId)
    {
    ...
    public function viewParticipantInvitationDetail($consultantId, $id)
    {
        $participantInviteeRepository = $this->em->getRepository(ParticipantInvitee::class);
