...
use Firm\Application\Service\Personnel\CoordinatorAttendee\ExecuteTaskAsMeetingInitiator;
...
use Firm\Domain\Task\MeetingInitiator\InviteAllProgramParticipantTask;
...
class AttendeeController extends AsMeetingInitiatorBaseController
{
    ...
    public function inviteManager($meetingId)
    {
        ...
        $coordinatorAttendeeRepository = $this->em->getRepository(CoordinatorAttendee::class);
        $service = new ExecuteTaskAsMeetingInitiator($coordinatorAttendeeRepository);
    ...
    public function inviteAllActiveProgramParticipants($meetingId)
    {
        ...
        $task = new InviteAllProgramParticipantTask($dispatcher);
