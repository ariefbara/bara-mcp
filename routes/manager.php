...
$router->group($managerAggregate, function () use ($router) {
    ...
    $router->post('/firm-file-infos', ['uses' => "FirmFileInfoController@create"]);
    //
    ...
    $router->get("/download-single-table-evaluation-report-summary-xls", ["uses" => "EvaluationReportSummaryController@downloadSingleTableSummaryXls"]);
    ...
    $router->get("/download-single-table-evaluation-report-transcript-xls", ["uses" => "EvaluationReportSummaryController@downloadSingleTableTranscriptXls"]);
